...
public class Home extends JFrame{
    ...
    public Home(String username) {
        super("Explore Bangladesh");
	this.username = username;
        setForeground(Color.CYAN);
        setLayout(null); 

        
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("travel/management/system/icons/nature1.jpg"));
        Image i2 = i1.getImage().getScaledInstance(1950, 1000,Image.SCALE_DEFAULT);
        ImageIcon i3 = new ImageIcon(i2); 
	JLabel NewLabel = new JLabel(i3);
	NewLabel.setBounds(0, 0, 1600, 1000); 
        add(NewLabel);
        
        JLabel l1 = new JLabel("Explore the beautiful Bangladesh!");
	l1.setForeground(Color.gray);
        l1.setFont(new Font("Tahoma", Font.PLAIN, 55));
	l1.setBounds(385, 60, 1000, 100);
	NewLabel.add(l1);
	...
	menuBar.add(m4);
        ...
        JMenuItem mi11 = new JMenuItem("BEAUTIFUL BANGLADESH");
	m4.add(mi11);
	...
	menuBar.add(m5);
        ...
        JMenuItem mi12 = new JMenuItem("PAY USING");
	m5.add(mi12);
